...
const LoginPage = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (!stored) { setError('User belum terdaftar.'); return }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Notch */}
          <div style={{
            width: '110px', height: '26px', background: '#0a0a0a',
            ...
            <div style={{ textAlign: 'center', marginTop: '24px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: '16px' }}>
                {['Privacy Policy', 'Terms', 'Support'].map(t => (
                  <span key={t} style={{ fontSize: '10px', color: '#0D307F',
                    fontWeight: 700, cursor: 'pointer' }}>{t}</span>
                ))}
              </div>
            </div>
